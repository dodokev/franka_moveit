#include "franka_moveit/octomap_cleaner.hpp"

static auto const LOGGER = rclcpp::get_logger("octomap_cleaner");
using namespace std::chrono_literals;

OctomapCleaner::OctomapCleaner()
    : Node("octomap_cleaner")
{
    ...
    sub_ = create_subscription<sensor_msgs::msg::PointCloud2>(
        ...
        std::bind(&OctomapCleaner::cloudCallback, this, std::placeholders::_1));

    timer_ = create_wall_timer(
        std::chrono::milliseconds(10),
        std::bind(&OctomapCleaner::updateOctomap, this));
}

void OctomapCleaner::cloudCallback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
...
std::shared_ptr<octomap::OcTree> OctomapCleaner::buildOctree()
{
...
octomap_msgs::msg::Octomap OctomapCleaner::toMsg(std::shared_ptr<octomap::OcTree> tree)
{
...
void OctomapCleaner::publishOctomap(std::shared_ptr<octomap::OcTree> tree)
{
...
void OctomapCleaner::updateOctomap()
{
    decayStep();
...
int main(int argc, char **argv)
{
    ...
    auto node = std::make_shared<OctomapCleaner>();
